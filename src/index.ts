...
export type {
  Degradation, FrameBodyProps, FrameViewProjection, ProjectedContent, ProjectedContentRef,
  ProjectedDivider, ProjectedFloat, ProjectedPane, ProjectedType, SplitBlock,
